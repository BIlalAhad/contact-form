...
function App() {
 ...
 const handle = (event) => {
  ...
  return (
    <div className="App h-screen grid place-items-center bg-gray-200 ">
     ...
     <input type="passward" value={data.conformpassward} placeholder="conform passward" name="conform passward" id="" className="text-sm rounded-md border-2 h-9 border-gray-400" onChange={handle} />
